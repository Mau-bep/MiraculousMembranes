...
public:
  ...
  SparseMatrix<double> LocalQWillmore(const Halfedge he, const Vector3 x0, const Vector3 x1, const Vector3 x2,
                                      const Vector3 x3) const;
  ...
  Eigen::Vector<double, 6> gradient_edge_length(Eigen::Vector<double, 6> Positions, double Edge_length) const;
  ...
  Eigen::Vector<double, 12> gradient_edge_regular(Eigen::Vector<double, 12> Positions,
                                                  Eigen::Vector<double, 5> Edge_lengths) const;
  Eigen::Vector<double, 12> gradient_edge_regular_I(Eigen::Vector<double, 12> Positions,
                                                    Eigen::Vector<double, 5> Edge_lengths) const;

  Eigen::Matrix<double, 12, 12> hessian_edge_regular(Eigen::Vector<double, 12> Positions) const;
  Eigen::Matrix<double, 12, 12> hessian_edge_regular(Eigen::Vector<double, 12> Positions,
                                                     Eigen::Vector<double, 5> Edge_lengths) const;
  ...
  Eigen::Vector<double, 9> gradient_edge_regular(Eigen::Vector<double, 9> Positions,
                                                 Eigen::Vector<double, 3> EdgeLenghts) const;
  Eigen::Matrix<double, 9, 9> hessian_edge_regular(Eigen::Vector<double, 9> Positions,
                                                   Eigen::Vector<double, 3> EdgeLenghts) const;
