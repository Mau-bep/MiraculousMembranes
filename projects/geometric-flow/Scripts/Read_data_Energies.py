...
def Read_data_file(folder_dir,KA,KB,KI,theta):
    ...
    plt.plot(time,Etot,label="Total energy", color='black')
    plt.plot(time,Ebend,label="Bending energy", color='blue')
    plt.plot(time,Esurf,label="Surface energy", color='red')
    plt.plot(time,Eedge,label="Edge energy", color='green')
    plt.plot(time,Ebead1,label="Bead 1 energy", color='orange')
    plt.plot(time,Ebead2,label="Bead 2 energy", color='purple')
    # plt.yscale('log')
    plt.xlabel("Time")
