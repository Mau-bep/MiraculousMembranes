...
def main_2():
    ...
    plt.plot(steps,Energy_evol[2],ls='dashed',color = "purple", label="{}, {} miliseconds".format(label_list[2], Sim_times[2]))
    plt.plot(Energy_evol[4], ls ='dotted',color="black",label="{}, {} miliseconds".format(label_list[4], Sim_times[4]))
    print(Energy_evol[4])
    plt.legend()
    plt.savefig("../Results/Timings/Energy_evolution_bending.png")
    plt.show()
    ...
    plt.legend()
    plt.savefig("../Results/Timings/Energy_evolution_surface_tension.png")
    plt.show()
...
def main():
    ...
    Bend_tension = "../Results/Timings/Surface_tension_1.0000_Bending_1.0000_Nsim_2"
    ...
    Bend_H1_tension_H1 = "../Results/Timings/H1_Surface_tension_1.0000_1.0000_1.0000_0.0000_H1_Bending_1.0000_1.0000_1.0000_0.0000_Nsim_2"
    Bend_H2_tension_H2 = "../Results/Timings/H2_Surface_tension_1.0000_1.0000_1.0000_0.0000_H2_Bending_1.0000_1.0000_1.0000_0.0000_Nsim_2"
    ...
    plt.legend()
    plt.savefig("../Results/Timings/Energy_evolution_double_2.png")
    plt.show()
...
def main_beads():
    ...
    Bend_Bead = "../Results/Timings/Bending_1.0000_Bead_radius_0.3000_str_400.0000_Nsim_2"
    Bend_H1_Bead_H1 = "../Results/Timings/H1_Bending_1.0000_1.0000_1.0000_0.0000_H1_Bead_radius_0.3000_str_400.0000_Nsim_2"
    Bend_H2_Bead_H2 = "../Results/Timings/H2_Surface_tension_1.0000_1.0000_1.0000_0.0000_H2_Bending_1.0000_1.0000_1.0000_0.0000_Nsim_2"
    ...
    plt.legend()
    plt.savefig("../Results/Timings/Energy_evolution_bead.png")
    plt.show()
