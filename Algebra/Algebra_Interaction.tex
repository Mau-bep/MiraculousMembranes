...
Ok i want to make a few changes, now instead of doing the normal per vertex i want to do the integral per triangle.



the code will look somehting like this

per face 

get area
get normal 
get energy at vertices 

E= 1/3 area *energy * (normal *r)
% this is kind of an area weighted normal but simpler
%  
